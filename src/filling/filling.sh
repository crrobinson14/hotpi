...
### BEGIN INIT INFO
# Provides:        hotpi-filling
# Required-Start:  $network $syslog
# Required-Stop:   $network $syslog
# Default-Start:   2 3 4 5
# Default-Stop:    1
# Short-Description: Start HotPi Filling daemon
### END INIT INFO
...
DAEMON=/usr/sbin/hotpi-filling
PIDFILE=/var/run/hotpi-filling.pid
CONFFILE=/etc/hotpi/filling.conf
SERVICE="hotpi-filling"
SRVNAME="HotPi Filling"
