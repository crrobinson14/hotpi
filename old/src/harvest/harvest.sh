...
### BEGIN INIT INFO
# Provides:        hotpi-harvest
# Required-Start:  $network $syslog
# Required-Stop:   $network $syslog
# Default-Start:   2 3 4 5
# Default-Stop:    1
# Short-Description: Start HotPi Harvest daemon
### END INIT INFO
...
DAEMON=/usr/sbin/hotpi-harvest
PIDFILE=/var/run/hotpi-harvest.pid
CONFFILE=/etc/hotpi/harvest.conf
SERVICE="hotpi-harvest"
SRVNAME="HotPi Harvest"
